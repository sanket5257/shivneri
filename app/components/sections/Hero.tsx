  ...
  return (
    <>
      <div className="h-screen bg-[#131214] text-white relative overflow-hidden">
        ...
        {/* Hero Content */}
        <div ref={heroRef} className="absolute top-30 sm:top-10 md:top-20 right-0 left-0 bottom-0 z-10 mx-auto max-w-[1728px] px-6 md:px-12 lg:px-24 pt-20 sm:pt-32 pb-20 md:pb-40 text-center">
